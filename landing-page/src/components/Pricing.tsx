          ...
          {pricingPlans.map((plan, index) => (
            <div 
              ...
              className={`
                ...
                ${plan.isPopular ? 'ring-2 ring-primary shadow-golden' : ''}
              `}
            ...
            >
              ...
              <div className="text-center mb-8">
                <div className={`
                  w-16 h-16 mx-auto mb-4 rounded-2xl flex items-center justify-center group-hover:animate-glow
                  ${plan.isPopular ? 'golden-gradient' : `bg-gradient-to-br ${plan.gradient}`}
                `}>
              ...
              <Button 
                className={`
                  w-full group/btn
                  ${plan.isPopular 
                    ? 'golden-gradient shadow-golden' 
                    : 'glass-button border-border hover:border-primary/50'
                  }
                `}
                size="lg"
              >
        ...
        <div className="text-center mt-16">
          <div className="glass-card p-8 max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button className="golden-gradient hover-scale">

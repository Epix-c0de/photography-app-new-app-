            ...
            children: List.generate(5, (index) {
              return GestureDetector(
                ...
                child: Icon(
                  Icons.star,
                  size: 14,
                  color: index < 3 ? AppTheme.gold : AppTheme.textTertiary,
                ),
              );
            }),
          ),
      ...
      itemBuilder: (context, index) {
        ...
        return PhotoGridItem(
          ...
          onRatingChanged: (rating) {
            ref.read(photosProvider.notifier).updateRating(photo.photoId, rating);
          },
        );
      },
    );

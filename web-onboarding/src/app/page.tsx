...
export default function LandingPage() {
  ...
  const navBg = scrollY > 50 ? 'rgba(255,255,255,0.92)' : 'transparent';
    ...
    <main className="min-h-screen bg-white text-zinc-900 overflow-hidden">
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <button onClick={() => setMobileMenuOpen(!mobileMenuOpen)} className="md:hidden p-2 text-zinc-500 hover:text-zinc-900">
        ...
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-zinc-100 bg-white/95 backdrop-blur-xl">
            <div className="px-4 py-6 space-y-4">
              <a href="#features" className="block text-zinc-500 hover:text-zinc-900 transition-colors" onClick={() => setMobileMenuOpen(false)}>Features</a>
              <a href="#how-it-works" className="block text-zinc-500 hover:text-zinc-900 transition-colors" onClick={() => setMobileMenuOpen(false)}>How It Works</a>
              <a href="#pricing" className="block text-zinc-500 hover:text-zinc-900 transition-colors" onClick={() => setMobileMenuOpen(false)}>Pricing</a>
              <a href="#testimonials" className="block text-zinc-500 hover:text-zinc-900 transition-colors" onClick={() => setMobileMenuOpen(false)}>Reviews</a>
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[500px] bg-[#D4AF37]/10 blur-[150px] rounded-full pointer-events-none" />
          <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-amber-100/40 blur-[100px] rounded-full pointer-events-none" />
          <div className="absolute inset-0 opacity-[0.03]" style={{ backgroundImage: 'linear-gradient(rgba(0,0,0,0.05) 1px, transparent 1px), linear-gradient(90deg, rgba(0,0,0,0.05) 1px, transparent 1px)', backgroundSize: '60px 60px' }} />
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              <div
                ...
                style={{ background: 'rgba(212,175,55,0.1)', border: '1px solid rgba(212,175,55,0.25)', color: '#b8941e', animation: 'fadeUp 0.8s ease-out' }}
              >
                <Camera size={14} />
              ...
              <h1 className="text-5xl sm:text-6xl md:text-7xl font-black leading-[0.9] tracking-tight mb-6" style={{ animation: 'fadeUp 0.8s ease-out 0.1s both' }}>
                <span className="text-zinc-900">Your galleries.</span>
                <br />
                ...
                <br />
                <span className="text-zinc-900">Your rules.</span>
              </h1>

              <p className="text-lg sm:text-xl text-zinc-500 max-w-xl mx-auto lg:mx-0 mb-10 leading-relaxed" style={{ animation: 'fadeUp 0.8s ease-out 0.2s both' }}>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 mb-12" style={{ animation: 'fadeUp 0.8s ease-out 0.3s both' }}>
                ...
                <Link href="/login" className="w-full sm:w-auto px-8 py-4 rounded-2xl font-bold text-lg border border-zinc-200 text-zinc-700 hover:border-zinc-300 hover:bg-zinc-50 transition-all text-center">
                  Sign In
                </Link>
              </div>
            ...
            <div className="hidden lg:flex justify-center" style={{ animation: 'fadeUp 0.8s ease-out 0.3s both' }}>
              <div className="relative">
                {/* Glow behind phone */}
                <div className="absolute inset-0 bg-[#D4AF37]/15 blur-[80px] rounded-full scale-110" />
                {/* Phone frame */}
                <div className="relative w-[280px] h-[560px] rounded-[3rem] border-2 border-zinc-200 bg-white p-3 shadow-2xl shadow-zinc-200/60">
                  {/* Notch */}
                  <div className="absolute top-0 left-1/2 -translate-x-1/2 w-32 h-6 bg-white rounded-b-2xl z-10" />
                  {/* Screen content */}
                  <div className="w-full h-full rounded-[2.2rem] overflow-hidden bg-gradient-to-b from-zinc-50 to-white p-4 pt-8">
                    {/* Status bar */}
                    <div className="flex items-center justify-between mb-6 px-1">
                      <span className="text-[10px] text-zinc-400">9:41</span>
                      <div className="flex gap-1">
                        <div className="w-3 h-2 rounded-sm bg-zinc-300" />
                        <div className="w-1 h-2 rounded-sm bg-zinc-300" />
                      </div>
                    </div>
                    {/* App header */}
                    <div className="flex items-center justify-between mb-4">
                      <div>
                        <p className="text-[10px] text-zinc-400">Welcome back</p>
                        <p className="text-sm font-bold text-zinc-900">Kamau Studio</p>
                      </div>
                      <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#D4AF37] to-[#F0D060] flex items-center justify-center text-[10px] font-bold text-white">K</div>
                    </div>
                    {/* Stats row */}
                    <div className="grid grid-cols-2 gap-2 mb-4">
                      <div className="rounded-xl p-3 bg-zinc-50 border border-zinc-100">
                        <p className="text-[10px] text-zinc-400">Galleries</p>
                        <p className="text-lg font-black text-[#D4AF37]">24</p>
                      </div>
                      <div className="rounded-xl p-3 bg-zinc-50 border border-zinc-100">
                        <p className="text-[10px] text-zinc-400">Clients</p>
                        <p className="text-lg font-black text-zinc-900">156</p>
                      </div>
                    </div>
                    {/* Gallery preview */}
                    <div className="rounded-xl overflow-hidden border border-zinc-100">
                      <div className="h-32 bg-gradient-to-br from-amber-50 via-amber-100/50 to-white flex items-center justify-center">
                        <Camera size={24} className="text-[#D4AF37]/50" />
                      </div>
                ...
                {/* Floating elements */}
                <div className="absolute -right-4 top-20 w-16 h-16 rounded-2xl bg-white/80 backdrop-blur-md border border-zinc-200 flex items-center justify-center shadow-lg animate-bounce" style={{ animationDuration: '3s' }}>
                  <CreditCard size={20} className="text-[#D4AF37]" />
                </div>
                <div className="absolute -left-4 bottom-32 w-14 h-14 rounded-2xl bg-white/80 backdrop-blur-md border border-zinc-200 flex items-center justify-center shadow-lg animate-bounce" style={{ animationDuration: '4s', animationDelay: '1s' }}>
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce">
          <div className="w-6 h-10 rounded-full border-2 border-zinc-300 flex items-start justify-center p-1.5">
      ...
      {/* How It Works */}
      <section id="how-it-works" className="relative py-32 bg-zinc-50/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <span className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full text-xs font-bold tracking-wider uppercase mb-6 bg-[#D4AF37]/10 text-[#b8941e] border border-[#D4AF37]/20">
              <Zap size={12} /> How It Works
            </span>
            <h2 className="text-4xl sm:text-5xl font-black mb-4 text-zinc-900">
              Three steps to<br />
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {steps.map((s, i) => (
              <div key={s.num} className="text-center relative group">
                ...
                <div className="rounded-2xl p-6 transition-all duration-300 group-hover:border-[#D4AF37]/40 group-hover:bg-white bg-white border border-zinc-100 shadow-sm">
                  ...
                  <h3 className="text-lg font-bold mb-2 text-zinc-900">{s.title}</h3>
                  <p className="text-zinc-500 text-sm leading-relaxed mb-3">{s.desc}</p>
                  <span className="inline-flex items-center px-3 py-1 rounded-full text-[10px] font-semibold bg-[#D4AF37]/10 text-[#b8941e] border border-[#D4AF37]/20">
                    {s.badge}
                  </span>
                </div>
              </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {features.map((f) => {
              ...
              return (
                <div
                  key={f.title}
                  className="group rounded-2xl p-7 transition-all duration-300 hover:border-[#D4AF37]/40 hover:bg-white hover:-translate-y-1 bg-white border border-zinc-100 shadow-sm"
                >
      ...
      {/* Pricing */}
      <section id="pricing" className="relative py-32 bg-zinc-50/50">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-zinc-500">One plan. No hidden fees. Cancel anytime.</p>
          </div>

          <div className="max-w-md mx-auto">
            <div className="relative rounded-3xl p-8 sm:p-10 transition-all duration-300 hover:border-[#D4AF37]/50 bg-white border-2 border-[#D4AF37]/30 shadow-xl shadow-[#D4AF37]/10">
              <div className="absolute -top-4 left-1/2 -translate-x-1/2 px-4 py-1 rounded-full text-xs font-bold bg-[#D4AF37] text-white">
                MOST POPULAR
              </div>

              <div className="text-center mb-8">
                <h3 className="text-2xl font-black mb-2 text-zinc-900">Photographer Pro</h3>
                <p className="text-zinc-500 text-sm">Everything you need, one price</p>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {testimonials.map((t) => (
              <div
                key={t.name}
                className="p-7 rounded-2xl transition-all duration-300 hover:border-[#D4AF37]/40 bg-white border border-zinc-100 shadow-sm"
              >
                ...
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full flex items-center justify-center font-bold text-sm bg-gradient-to-br from-[#D4AF37] to-[#F0D060] text-white">
                    {t.name.charAt(0)}
                  </div>
                  <div>
                    ...
                    <p className="text-xs text-zinc-400">{t.handle} • {t.role}</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      {/* CTA */}
      <section className="relative py-32 bg-zinc-50/50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="rounded-3xl p-12 sm:p-16 bg-gradient-to-br from-[#D4AF37]/10 to-[#D4AF37]/5 border border-[#D4AF37]/20">
            <h2 className="text-4xl sm:text-5xl font-black mb-4 text-zinc-900">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Link href="/login" className="w-full sm:w-auto px-8 py-4 rounded-2xl font-bold text-lg border border-zinc-200 text-zinc-700 hover:border-zinc-300 hover:bg-white transition-all text-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-8">
              <a href="#features" className="text-sm text-zinc-400 hover:text-zinc-900 transition-colors">Features</a>
              <a href="#pricing" className="text-sm text-zinc-400 hover:text-zinc-900 transition-colors">Pricing</a>
              <a href="#testimonials" className="text-sm text-zinc-400 hover:text-zinc-900 transition-colors">Reviews</a>
              <a href="mailto:epixshots002@gmail.com" className="text-sm text-zinc-400 hover:text-zinc-900 transition-colors">Support</a>
            </div>
            <p className="text-xs text-zinc-400">&copy; {new Date().getFullYear()} Epix Visuals. All rights reserved.</p>
          </div>
        </div>
      </footer>

  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      const { error } = await supabase.auth.signInWithOAuth({
        provider: 'google',
        options: {
          redirectTo: 'https://epix-visuals.vercel.app/auth/callback',
        },
      });
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        >
          ...
          <button
            ...
            className="w-full py-3 rounded-xl font-semibold text-xs border border-zinc-200 text-zinc-700 hover:bg-zinc-50 hover:border-zinc-300 transition-all flex items-center justify-center gap-2 disabled:opacity-50"
          >
            {googleLoading ? (
